...
dbutils.fs.rm("dbfs:/tmp/instacart_order_picking/", True)
dbutils.fs.mv("file:/databricks/driver/aisles.csv", "dbfs:/tmp/instacart_order_picking/bronze/aisles/aisles.csv")
dbutils.fs.mv("file:/databricks/driver/departments.csv", "dbfs:/tmp/instacart_order_picking/bronze/departments/departments.csv")
dbutils.fs.mv("file:/databricks/driver/order_products__prior.csv", "dbfs:/tmp/instacart_order_picking/bronze/order_products/order_products__prior.csv")
dbutils.fs.mv("file:/databricks/driver/order_products__train.csv", "dbfs:/tmp/instacart_order_picking/bronze/order_products/order_products__train.csv")
dbutils.fs.mv("file:/databricks/driver/orders.csv", "dbfs:/tmp/instacart_order_picking/bronze/orders/orders.csv")
dbutils.fs.mv("file:/databricks/driver/products.csv", "dbfs:/tmp/instacart_order_picking/bronze/products/products.csv")
