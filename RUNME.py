...
job_json = {
        ...
        "tasks": [
            {
                "job_cluster_key": "order_picking_cluster",
                "notebook_task": {
                    "notebook_path": f"00_Intro & Config"
                },
                "task_key": "order_picking_01"
            },
            {
                "job_cluster_key": "order_picking_cluster",
                "notebook_task": {
            ...
            },
            {
                "job_cluster_key": "order_picking_cluster",
                "notebook_task": {
                    "notebook_path": f"02_Order Optimizations"
                },
                "task_key": "order_picking_03",
                "depends_on": [
                    {
                        "task_key": "order_picking_02"
                    }
